...
Note that we have provided copies of various binaries we depend upon.  If you experience difficulties using the provided .so files, you may need to build your own. Symptoms may include nonfunctional music, or issues with controller input.  Please see Assets/Documentation/Building-Linux-Native-Dependencies.md[this document] for help with native dependencies.
